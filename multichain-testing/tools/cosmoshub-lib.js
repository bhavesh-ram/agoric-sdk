...
const trace = makeTracer('CosmosHub', false);
 ...
 */
export const makeCosmosHubd = ({ execFileSync }) => {
  /**
   * @param { {
   *       home?: string;
